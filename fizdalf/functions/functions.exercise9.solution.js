...
const concatenateLibrary = require("./functions.exercise6.solution");
const reverseCharactersLibrary = require("./functions.exercise7.solution");
const calculateRaiseLibrary = require("./functions.exercise8.solution");
// concatenateLibrary.concatenate();
// calculateRaiseLibrary.calculateRaise();
