...
function Smiley(size, linePixelColor, fillPixelColor) {
    ...
    drawCircle(size / 2, size / 2, size / 5, circle);
    drawCircle(size * 1.5, size / 2, size / 5, circle);
    drawArch(size, size, size / 2, 0, 180, circle);
...
// drawShape(Smiley(500, Pixel(0, 0, 0, 255), Pixel(255, 255, 0, 255)))
