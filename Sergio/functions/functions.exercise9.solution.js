...
const [, , nameString, surNameString, baseSalaryString,YearsWorkingCompanyString] = process.argv


function gainYourRaise(name, surName, baseSalary, YearsWorkingCompany){
    concatenateLibrary
    return
}