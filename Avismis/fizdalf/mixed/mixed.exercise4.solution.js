...
// const {Pixel} = require("./mixed.exercise1.solutions"); // make sure to import correctly from the previous exercise
// const {Square} = require("./mixed.exercise3.solution"); // make sure to import correctly from the previous exercise
